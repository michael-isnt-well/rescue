---
title: Cleared to travel — Barnie's booked on the bus
description: Barnie's health tests came back clear, so he's booked onto Pawprints' transport out of Romania on 22 September. The open-ended wait finally has a date.
publishedAt: 2026-09-11
guidesReferenced:
  - transport-day
  - decompression-first-three-weeks
...
So the wait has changed shape. It's not "someday" any more, it's a countdown — and a to-do list. The safe space is coming together. The harness and backup lead are by the door, because everything I've read about [transport day](/guides/transport-day) and [those first three weeks](/guides/decompression-first-three-weeks) says the same thing: plan the arrival before he's anywhere near home.

We've received a few photos, short videos, a description, and now a travel date. But the next time I write, he might actually be here. And we'll get to know him for real. I've read it can be anything from 2 to 4 days on the road from Romania, and then, finally, Barnie.
