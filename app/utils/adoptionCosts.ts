...
export const RESCUE_FEES: RescueFee[] = [
  // Romania
  {
    ...
    note: 'Covers transport, vaccinations and tests, microchip, pet passport, import customs and neutering for dogs over 9 months. Reduced fees for older dogs.',
    sourceUrl: 'https://www.pawprints2freedom.co.uk/_files/ugd/3a38a8_e4a18f64e02b419293fdd868c0bc4062.pdf',
  ...
  },
  {
    ...
    country: 'romania',
    variant: 'Puppy under 9 months',
    fee: 620,
    parts: [
      { label: 'Adoption fee (transport included)', amount: 520 },
      { label: 'Neutering deposit (refundable)', amount: 100 },
    ],
    note: 'The £100 deposit is refunded if you have your puppy neutered within 6 months of arrival, so the neutering itself is then a separate vet bill.',
    sourceUrl: 'https://www.pawprints2freedom.co.uk/_files/ugd/3a38a8_e4a18f64e02b419293fdd868c0bc4062.pdf',
    profilePath: '/rescues/pawprints-to-freedom',
  },
  {
